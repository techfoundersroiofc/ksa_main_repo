        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 relative">
            ...
            <div className="absolute -bottom-6 -right-4 sm:bottom-8 sm:-right-6 bg-[#0A192F] text-white p-6 rounded-3xl shadow-2xl border border-[#D4AF37]/30 max-w-xs">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <span className="text-2xl font-extrabold text-white font-heading">20+ Years</span>
                  <span className="text-xs text-slate-400 block">Academic Excellence</span>
                </div>
              </div>
              <p className="text-xs text-slate-300">
                Governing constituent institutions with statutory approvals across Healthcare, Pharma & Marine studies.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="space-y-4 text-slate-600 text-sm leading-relaxed">
              <p>
                Our constituent campuses—spanning Nursing, Pharmaceutical Sciences, and Maritime Nautical Sciences—feature multi-specialty clinical simulation centers, advanced chemical analytics laboratories, and 360-degree full-mission ship simulators.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-sm flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-[#0A192F] text-sm">Recognized Standards</h4>
                  <p className="text-xs text-slate-500">INC, PCI, AICTE, DGS & University Affiliated</p>
                </div>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-white border border-slate-200/80 shadow-sm flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-bold text-[#0A192F] text-sm">Industry Immersion</h4>
                  <p className="text-xs text-slate-500">Direct hospital wards, pharma R&D & shipping fleets</p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-4 flex items-center gap-4">
              <Link
                href="/about"
                className="px-6 py-3.5 rounded-xl bg-[#0A192F] hover:bg-[#162C4E] text-[#D4AF37] font-bold text-sm transition-colors inline-flex items-center gap-2"
              >
